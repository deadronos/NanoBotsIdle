...
- [TASK005] Worker engine migration — Drones + economy moved into Worker; UI becomes read-only snapshot (In Progress)
- [TASK006] Voxel world model v1 — 3D digging + bedrock + frontier + prestige safety (In Progress)
