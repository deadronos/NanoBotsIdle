...
import type { Group, Mesh, MeshBasicMaterial, PointLight, Vector3 } from "three";
...
export const updateDronesFrame = (options: {
  ...
  const elapsedTime = frameState.clock.elapsedTime;
